...
## Summary
- 483 nodes · 31 edges · 453 communities (4 shown, 449 thin omitted)
...
- [[_COMMUNITY_File Tree Explorer|File Tree Explorer]]
- [[_COMMUNITY_Hotkey System|Hotkey System]]
- [[_COMMUNITY_Icon Pack Service|Icon Pack Service]]
- [[_COMMUNITY_Dock Layout System|Dock Layout System]]
- [[_COMMUNITY_Theme Service|Theme Service]]
- [[_COMMUNITY_Search & Shell Layout|Search & Shell Layout]]
- [[_COMMUNITY_Git Worker|Git Worker]]
...
- `LSP Manager` --references--> `MonacoEditor Component`  [INFERRED]
  src/lib/lsp/manager.ts → src/components/editor/MonacoEditor.tsx
- `ShellLayout Component` --calls--> `SearchBar Component`  [INFERRED]
  src/components/layout/ShellLayout.tsx → src/components/search/SearchBar.tsx
- `ScannedExtension` --references--> `ExtensionManifest`  [EXTRACTED]
...
## Communities (453 total, 449 thin omitted)

### Community 0 - "Core Editor Services"
Cohesion: 0.29
Nodes (8): Editor Store, File Store, LSP Manager, MonacoEditor Component, Settings Store, StatusBar Component, useAutoSave Hook, useGitGutterDecorations Hook

### Community 1 - "Editor Tabs & Split View"
Cohesion: 0.40
